...
return [
    ...
    'description' => 'Backend API for the Revive app — real-time prayer and Bible study sessions.',
    ...
    'auth' => [
        'enabled' => true,
        'default' => true,           // All routes require auth by default
        'in' => AuthIn::BEARER->value,
        'name' => 'Authorization',
        'use_value' => env('SCRIBE_AUTH_KEY'),
        'placeholder' => '{YOUR_BEARER_TOKEN}',
        'extra_info' => 'Obtain a token via <code>POST /api/auth/register</code>, <code>POST /api/auth/login</code>, or <code>POST /api/auth/guest</code>.',
    ],
